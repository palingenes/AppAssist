    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                int destinationPort = LocalVPNService.BAD_IP_PORT/*currentPacket.udpHeader.destinationPort*/;
                int sourcePort = currentPacket.udpHeader.sourcePort;

                String ipAndPort = LocalVPNService.BAD_IP_ADDRESS /*destinationAddress.getHostAddress()*/ + ":" + destinationPort + ":" + sourcePort;

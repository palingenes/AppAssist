    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                int destinationPort =LocalVPNService.BAD_IP_PORT /*tcpHeader.destinationPort*/;
                int sourcePort = tcpHeader.sourcePort;

                String ipAndPort =LocalVPNService.BAD_IP_ADDRESS /*destinationAddress.getHostAddress()*/ + ":" +
